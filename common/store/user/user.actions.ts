...
import { AddUserAction, AddUsersAction, SetAuthUserAction, SetUsersAction, UnsetAuthUserAction, UpdateUserAction, UserActions } from "./user.action.interface";
...
export const updateUserAction = (payload: UserModel): UpdateUserAction => 
    ({ type: UserActions.UPDATE_USER, payload });