...
export const PropertyCard: FC<IProps> = ({
    ...
    <div className={clsx("bg-white shadow-lg rounded-md w-full flex-shrink-0", className)}>
        <Image className="w-full object-cover object-center rounded-md" src={imgPath} alt={title} height={249} width={444} />
